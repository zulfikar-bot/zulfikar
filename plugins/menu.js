...
® ${pmenus} DILARANG BICARA KOTOR DI BOT | *HARUS MENGHORMATI*
® ${pmenus} GUNAKAN BOT SEBAIK MUNGKIN | *PASTI FAHAMLAH*
® ${pmenus} OWNER BOT : Zulfikar-Bot

`, rowId: ".donasi", description: `${namebot}`},
...
const listMessage = {
 ...
 let mode = global.opts['self'] ? 'Private' : 'Publik'
  ...
  let fkon = { key: { fromMe: false, participant: `${m.sender.split`@`[0]}@s.whatsapp.net`, ...(m.chat ? { remoteJid: '6282279425257@s.whatsapp.net' } : {}) }, message: { contactMessage: { displayName: `${name}`, vcard: `BEGIN:VCARD\nVERSION:3.0\nN:;a,;;;\nFN:${name}\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`}}}
    ...
    const message = {
            ...
            pageCount: fpagedoc,
            caption: text,
            footer: titlebot + '\n⚡ Supported By Zulfikar-Bot',
            templateButtons: [
                {
                    urlButton: {
                        displayText: `${namebot}`,
                        url: 'https://zulfikar-bot.glitch.me/'
                    }
                },
                {
                    urlButton: {
